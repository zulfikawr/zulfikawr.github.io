...
import { SiSpotify, SiWhatsapp, SiLinkedin, SiGithub } from 'react-icons/si';
        ...
        <main className="mx-auto grid max-w-3xl grid-cols-6 gap-6 px-6 pt-4 md:pt-16">
          ...
          <CardHoverEffect className="col-span-3 h-full md:col-span-3">
            ...
            >
              ...
              <span
                aria-hidden
                className="px-2 pt-3 pb-4 md:px-6 md:pt-6 md:pb-4"
              >
          ...
          <div className="col-span-6 space-y-2 rounded-2xl p-6 md:col-span-4 custom-card">
            <p className="text-sm">
              Hi. My name is Zulfikar, I'm a data analyst and web developer from
              Indonesia. I'm currently a 4th semester student majoring in
              International Relations at UPNVJ.
            </p>

            <p className="text-sm">
              My objective is to integrate data analytics with the field of
              international relations to analyze how countries interact
