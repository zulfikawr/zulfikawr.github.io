...
function BlogLink(props: {
  ...
  return (
    <li>
      <Link className="hover:underline dark:text-white" href={props.href}>
        {props.children}
      </Link>
    </li>
  );
            ...
            <div className="relative flex items-center">
              ...
              <div className="hidden md:block absolute inset-y-0 right-0 top-2 flex items-center pr-3">
                <span className="ml-2 text-xs text-gray-500 dark:text-gray-300">
                  <kbd className="px-1 py-0.5 shadow-md bg-cream text-gray-700 rounded dark:bg-gray-800 dark:text-gray-300">
                    Ctrl
                  </kbd>{' '}
                  +{' '}
                  <kbd className="px-1 py-0.5 shadow-md bg-cream text-gray-700 rounded dark:bg-gray-800 dark:text-gray-300">
