...
export class Quantium extends Post {
    ...
    public hidden = false;
    public excerpt = 'My experience as a data analyst intern at Quantium, working on retail analytics projects.';
    public keywords = ['Quantium', 'internship', 'data analyst', 'retail analytics', 'Python', 'Jupyter Notebook', 'Power BI'];
    public render() {
        return (
            <>
                ...
                <ol>
                    <li><strong>Data Checks:</strong> Conducting data summaries, removing outliers, and correcting formats to ensure data integrity.</li>
                    <li><strong>Feature Engineering:</strong> Deriving new features such as pack size and brand name from the product descriptions.</li>
                    <li><strong>Customer Segmentation:</strong> Defining metrics to understand different customer segments and their spending behavior.</li>
                </ol>
                ...
                <ul>
                    <li>Analyzing monthly sales data: total sales revenue, customer count, and average transactions per customer.</li>
                    <li>Creating a measure to compare trial stores with control stores.</li>
                    <li>Performing statistical tests to determine the significance of the results.</li>
                </ul>
                ...
                <ul>
                    <li>Using the output from previous tasks to create comprehensive charts and visualizations.</li>
                    <li>Developing a Power BI report that highlighted key insights and recommendations for the client.</li>
                </ul>
