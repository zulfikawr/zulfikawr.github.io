...
export class SearchingGitHubForOpenAIApiKeys extends Post {
  ...
  public hidden = false;
  public excerpt =
    'How to search for OpenAI API keys on GitHub using regular expressions.';
  ...
  public render() {
    return (
      <>
        ...
        <p>
          This matches any string that starts with “sk-” followed by at least 40
          alphanumeric characters.
        </p>
        <p>
          GitHub allows regular expression search, but note that if the search
          is too expensive you’ll get a 5XX response.
        </p>
        <p>
          I noticed that modifying it to limit to the start of a line, i.e.,{' '}
          <code>/^sk-[a-zA-Z0-9]{'{40,}'}/</code> yields better results.
        </p>
        <p>
          <a
            className="link"
            href="https://github.com/search?q=%2F%5Esk-%5Ba-zA-Z0-9%5D%7B40%2C%7D%2F&type=code"
            target="_blank"
        ...
        <ul>
          <li>
            I’m not sure if GitHub is sending alerts for API keys being
            committed to codebases. They absolutely should if they’re not.
          </li>
